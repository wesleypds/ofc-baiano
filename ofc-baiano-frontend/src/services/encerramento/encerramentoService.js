...
export const ListAll = async () => {
  try {
    const result = await get('/encerramentos');
    return result
  } 
  catch (error) {
    return {
...
export const DeleteById = async (id) => {
  try {
    const result = await del('/encerramentos',id);
    return result
  } 
  catch (error) {
    return {
...
export const GetById = async (id) => {
  try {
    return await get('/encerramentos/'+id);
  } 
  catch (error) {
    return {
      success: false,
...
export const SendFormPost = async (data) => {
  try {
    return await postData('/encerramentos', data);
  } 
  catch (error) {
    return {
      success: false,
...
export const SendFormPut = async (data) => {
  try {
    return await putData('/encerramentos', data);
  } 
  catch (error) {
    return {
      success: false,
