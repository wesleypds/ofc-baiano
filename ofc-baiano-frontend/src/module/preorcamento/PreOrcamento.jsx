...
import { TextField, FormControl, Box, Select, MenuItem, InputLabel, FormHelperText } from "@mui/material";
...
const PreOrcamento = () => {
  ...
  const submitForm = ()=>{
    if(validate()){
      HandleSubmitForm(id, "preorcamentos", dataForm, setIsInvalidForm, setMsgInvalidForm,locationUrl, navigate)
    }
  }
        ...
        <div className="row mt-4 justify-content-md-center">
          <div className="col-6">
            <FormControl fullWidth>
             ...
             <FormControl fullWidth required error={!!errors.escolha} className={`mb-3 ${isReadOnly ? 'input-readonly-field' : ''}`}>
